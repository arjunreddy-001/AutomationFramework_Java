...
//						String str = Utils.stackTrace(exception, true)[0];
				...
				buff.append("<td><a href='#m" + m_methodIndex + "'>" + qualifiedName(method) + " "
						...
						+ "<td class='numi' style='text-align:left;padding-right:2em'><div style='max-width:600px;overflow:hidden;' ><pre style='white-space: pre-wrap;'>"
						+ firstLine + "</pre></div><br/></td>" + "<td style='text-align:right'>" + reqstarttime
						+ "</td>" + "<td class='numi'>" + timeConversion(end - start) + "</td>" + "</tr>");
	...
	private void startResultSummaryTable(String style) 
	{
		...
		writer.println("<tr><th>Test Name</th>"
				+ "<th>Test Validations</th><th><div style='max-width:600px;overflow:hidden;'> Exception Info </div></th><th>Start Time </th><th>Execution Time<br/>(hh:mm:ss)</th></tr>");
		m_row = 0;
	}
...
//		writer.print(Utils.stackTrace(exception, true)[0]);
	...
	protected void startHtml(PrintWriter out) 
	{
		...
		out.println("table {margin-bottom:10px;border-collapse:collapse;empty-cells:show;margin-left:auto;margin-right:auto;}");
